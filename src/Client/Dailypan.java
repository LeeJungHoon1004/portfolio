...
public class Dailypan extends JPanel {
	...
	private Image cupimage = new ImageIcon("empty2.png").getImage().getScaledInstance(43, 72,
			java.awt.Image.SCALE_SMOOTH); // 빈컵이미지
	private Image fullcupimage = new ImageIcon("full2.png").getImage().getScaledInstance(43, 72,
